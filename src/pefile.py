...
class SectionStructure(Structure):
    ...
    def xor_data(self, code=0x55, offset=0):
        data = self.get_data()
        new_data = ""
        for b in data:
            if b:
        ...
        self.pe.set_bytes_at_offset(self.PointerToRawData + offset, new_data)
...
class PE:
    ...
    def add_last_section(self,name = "."+random_string(3, 7) , size=512):
        ...
        section.Name = extend_to_size(name, size=8)
        section.Misc = size
